#> asset:object/projectile.zombie_bullet/register
#
# Objectのデータを指定
#
# @within function asset:object/_alias/projectile.zombie_bullet/register
...
# ID (int)
    data modify storage asset:object ID set value "projectile.zombie_bullet"
# フィールド: 
    ...
    # item
        data modify storage asset:object Field.Item set value {id:"minecraft:zombie_head",count:1}
    # item_display
