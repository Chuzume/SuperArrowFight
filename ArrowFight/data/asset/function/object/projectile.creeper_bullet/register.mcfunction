#> asset:object/projectile.creeper_bullet/register
#
# Objectのデータを指定
#
# @within function asset:object/_alias/projectile.creeper_bullet/register
...
# フィールド: 
    ...
    # item
        data modify storage asset:object Field.Item set value {id:"minecraft:creeper_head",count:1}
    # item_display
