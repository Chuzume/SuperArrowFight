...
# Objectのデータを指定
#
# @within function asset:object/_alias/projectile.lightning_bullet/register
...
# フィールド: 
    ...
    # item
        data modify storage asset:object Field.Item set value {id:"minecraft:sea_lantern",count:1}
    # item_display
