...
# Objectのデータを指定
#
# @within function asset:object/_alias/projectile.poison_mist_bullet/register
...
# フィールド: 
    ...
    # item
        data modify storage asset:object Field.Item set value {id:"minecraft:player_head",count:1}
    # item_display
