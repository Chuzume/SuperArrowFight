...
# 商品
    ...
    # 通常矢
        ...
        data modify entity @s Offers.Recipes[0].sell set value {id:"minecraft:arrow",count:2,components:{"minecraft:custom_name":{"color":"white","italic":false,"text":"ふつうの矢"},"minecraft:lore":[{"color":"white","italic":false,"text":"特にこれといった効果のない、普通の矢。","minecraft:custom_data":{projectile:normal_arrow}}]}}
