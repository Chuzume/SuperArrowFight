...
# ショップのID(String)
    data modify storage lib: Shop.ID set value "ArrowShop"

# ショップ名(TextComponent)
    data modify storage lib: Shop.Name set value {"color":"white","fallback":"Projectile Shop","translate":"dialog.shop.arrow_shop.name","underlined":false}
